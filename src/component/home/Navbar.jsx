...
<a id="top"></a>
    ...
    <IoSearch className="search-button"/>
                ...
                <nav className="list">
                    <ul>
                        ...
                        <MdFormatListBulletedAdd />
                             ...
                             <span onClick={()=>setpopup(true)}> Tous les rayons </span></li>
            ...
            <div className="Promo"> Souscrivez à <span style={{textDecoration:"underline" , fontWeight: "600"}}> Cdiscount à volonté : </span> <b> 15€ </b> <span style={{textDecoration:"line-through"}}> 29€ </span> /an pour profiter des <span style={{textDecoration:"underline" , fontWeight: "600"}}>offres Coup de Boost </span> ✨ 1ère commande ? 10€ offerts en plus ! <span style={{textDecoration:"underline"}}> Profitez-en </span></div>        
        {showpopup&&
        <div className="popup">   
        <div className="first-header-popup">
            <h1>Nos Rayons</h1>
            <FiX className="delete-button" onClick={()=>setpopup(false)}/>
        </div>
        <div className="second-header-popup"><span class="c-stores__img">
            <img className="promo-img" src="https://i2.cdscdn.com/nav/images/20.jpg" alt="Promo" loading="lazy"/></span>
                            <h1>Promo</h1>
        </div>
        <div></div>
        <div></div>
